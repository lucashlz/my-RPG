...
static void write_text_bako_girl(rpg_t *rpg, int which, int x, int y)
{
    ...
    sfText_setString(text_girl, "Ne t'inquiete pas, c'est ton pere qui m'envoie"
    "\npour te sauver ! Allons le rejoindre !");
